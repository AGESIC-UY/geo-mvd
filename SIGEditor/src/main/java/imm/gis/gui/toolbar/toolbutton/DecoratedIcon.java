...
abstract public class DecoratedIcon extends ImageIcon {
    ...
    protected void init(int[][] buffer) {
        ...
        int newWidth = _imageIcon == null ? 1 : _imageIcon.getIconWidth() + _popupIconOffset + _popupIconWidth;
        int newHeight = _imageIcon == null ? 1 : _imageIcon.getIconHeight();
        ...
        g2.drawImage(_imageIcon == null ? null : _imageIcon.getImage(), null, null);
